...
for t in t_vals:
    ...
    punto2 = generar_punto_elipse(a1, b1, t)
    
    # Dibujar el punto en la elipse
    cv2.circle(imagen, punto, radius=10, color=(0, 255, 0), thickness=-1)
    cv2.circle(imagen, punto2, radius=10, color=(248, 243, 43), thickness=-1)
    ...
    for t_tray in t_vals:
        ...
        pt_tray = generar_punto_elipse(a1, b1, t_tray)
        cv2.circle(imagen, pt_tray, radius=1, color=(255, 255, 255), thickness=-1)
