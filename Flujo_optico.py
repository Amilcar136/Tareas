...
while True:
    ...
    # Verificar si la pelotita ha tocado el rectángulo
    rect_x, rect_y, rect_w, rect_h = 10, 10, 600, 450
    if (a > rect_x and a < rect_x + rect_w and
            b > rect_y and b < rect_y + rect_h):
        rect_color = (0, 0, 255)  # Cambiar el color del rectángulo a rojo
    else:
        rect_color = (234, 43, 34)  # Restaurar el color original del rectángulo
    
    #rectangulo (borde de la pelota)
    cv.rectangle(frame, (10, 10), (600, 450), (234,43 ,34) ,5)
    center_x = x//2
    center_y = y//2
    #lineas
    cv.line(frame, (center_x, 0), (center_x, y), (255,0,0), 5)
    cv.line(frame, (0, center_y), (x, center_y), (255, 0, 0), 5)
